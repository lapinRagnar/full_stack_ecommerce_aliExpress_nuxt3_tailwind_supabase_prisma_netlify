  ...
  <div id="MainLayout" class="w-full fixed z-50">
    ...
    >
      ...
      >
        ...
        <li class="border-r border-r-gray-400 px-3 hover:font-bold  hover:text-[#FF4646] cursor-pointer">
          Sell on AliExpress
        </li>
        <li class="border-r border-r-gray-400 px-3 hover:font-bold  hover:text-[#FF4646] cursor-pointer">
          Cookie Preferences
        ...
        <li class="px-3 hover:text-[#FF4646] cursor-pointer">
          <Icon name="ic:sharp-install-mobile" size="20"></Icon>
          App
        </li>
        ...
        <li 
          ...
          :class="isAccountMenu ? 'bg-green border z-40 shadow-[0_15px_100px_40px_rgba(0,0,0,0.3)]' : 'border border-[#FADAFA]' "
        >

          <Icon name="ph:user-thin" size="20"/>
          Account
          <Icon name="mdi:chevron-down" size="20" class="ml-5" />
    ...
    >
      ...
      <div class="flex lg:justify-center justify-between gap-10 max-w-[1150px] mx-auto w-full px-3 py-5">
        <NuxtLink
          to="/"
          class="min-w-[170px]"
        >
        ...
        <div class="max-w-[700px] md:block hidden" w-full >
          <div class="relative">
            <div class="flex items-center border-2 border-[#FF4646] rounded-md w-full ">
              <input 
                class="w-full lg:w-80 placeholder-gray-400 text-sm pl-3 focus:outline-none"
            ...
            <div class="absolute bg-white max-w-[700px] h-auto w-full]">
              <div v-if="false" class="p-1">
                <NuxtLink
                  to="`/item/1`"
                  class="flex items-center justify-between w-full cusror-pointer hover:bg-gray-100"
                >
